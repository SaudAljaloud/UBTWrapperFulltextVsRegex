...
public class ConfigFile {
	...
	public String className = "saud.ubt.wrapper.StarDog.StarDogFactory";
	public String dataSource = "../../LUBM/LUBM-fulltext-1/";
	public String databaseName = "LUBM-fulltext-1";
