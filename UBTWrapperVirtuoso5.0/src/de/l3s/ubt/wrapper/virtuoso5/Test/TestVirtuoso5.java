...
public class TestVirtuoso5 {
	...
	public void issueQuery(String query) {
		...
		try {
			...
			int totalno = 0;
			ResultSet rs = this.stmt.executeQuery("sparql " + query);
			// ResultSet rs2 = this.stmt.executeQuery("sparql " + query);
			...
			System.out.println("========");
			System.out.println("No of Results: " + rowtotal);
			// while (rs2.hasNext() && r2.next() != null)
			// totalno++;
